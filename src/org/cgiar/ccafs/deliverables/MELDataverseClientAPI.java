 ...
 */
public class MELDataverseClientAPI extends DataverseClientApi {

  private final String REST_URL = "https://data.mel.cgiar.org/api/datasets/:persistentId/?persistentId={0}";
  ...
  public String parseLink(String link) {
    Map<String, List<String>> map = MELDataverseClientAPI.getQueryParams(link);
